...
## まとめ
今回は，畳み込みニューラルネットワーク（CNN）について触れていきました．Global Average Poolingは単に一般物体認識だけでなく，深層生成モデルの分野でも使われる重要な重要なテクニックです．また，前回までに登場したドロップアウトやバッチ正規化もよくCNNで使われる手法であることは，間違いないです．今後，GAPと合わせて意識しておくと良いかもしれません．
