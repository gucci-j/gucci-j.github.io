...
pip install keras
```
_<i class="fas fa-link" style="padding: 0 2px 0 0;"></i>参考: [https://keras.io/ja/](https://keras.io/ja/)_
...
```
_<i class="fas fa-book-open" style="padding: 0 2px 0 0;"></i>参照: ゼロから〜のP27_
...
```
_<i class="fas fa-link" style="padding: 0 2px 0 0;"></i>参考: [https://keras.io/ja/getting-started/functional-api-guide/](https://keras.io/ja/getting-started/functional-api-guide/)_
