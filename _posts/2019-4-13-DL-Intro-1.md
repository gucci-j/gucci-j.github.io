...
pip install keras
```
参考: [https://keras.io/ja/](https://keras.io/ja/)
...
* 初めてレイヤーを追加するときには，`input_shape`を指定する必要があります
```
model.add(Dense(input_dim=2, units=1))
```

* 全結合層という用語はゼロから〜の二章には登場していませんが，ここではパーセプトロンと同じと思ってください．  
...
```
参考: [https://keras.io/ja/getting-started/functional-api-guide/](https://keras.io/ja/getting-started/functional-api-guide/)
