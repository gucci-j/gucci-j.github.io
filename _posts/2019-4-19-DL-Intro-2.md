...
_（3層ニューラルネットワーク）参考: ゼロから〜のP58〜65_  
_（MNIST）参考: ゼロから〜のP72〜81_

* ゼロから作るDeep Learningとともに学ぶフレームワークシリーズの各リンク  
[第一弾：パーセプトロン編](https://gucci-j.github.io/DL-Intro-1/)   
[第二弾：3層ニューラルネットワーク & 手書き数字認識編](https://gucci-j.github.io/DL-Intro-2/)  
[第三弾：ニューラルネットワークの学習編](https://gucci-j.github.io/DL-Intro-3/)  
第四弾：学習テクニック編  
第五弾：畳み込みニューラルネットワーク編  
...
```
_参考: [https://keras.io/ja/activations/](https://keras.io/ja/activations/)_
...
print(y_train.shape)
```
_参照: [https://keras.io/ja/datasets/#mnist](https://keras.io/ja/datasets/#mnist)_
...
_参考: [Kerasでモデルの保存/ロードを行う](https://keras.io/ja/getting-started/faq/#keras-model)_
