...
_（3層ニューラルネットワーク）<i class="fas fa-book-open" style="padding: 0 2px 0 0;"></i>参考: ゼロから〜のP58〜65_  
_（MNIST）<i class="fas fa-book-open" style="padding: 0 2px 0 0;"></i>参考: ゼロから〜のP72〜81_
...
```
_<i class="fas fa-link" style="padding: 0 2px 0 0;"></i>参考: [https://keras.io/ja/activations/](https://keras.io/ja/activations/)_
...
```
_<i class="fas fa-book-open" style="padding: 0 2px 0 0;"></i>参照: ゼロから〜 P65_
...
_<i class="fas fa-book-open" style="padding: 0 2px 0 0;"></i>参考: ゼロから〜のP72〜81_
...
print(y_train.shape)
```
_<i class="fas fa-link" style="padding: 0 2px 0 0;"></i>参照: [https://keras.io/ja/datasets/#mnist](https://keras.io/ja/datasets/#mnist)_
...
_<i class="fas fa-link" style="padding: 0 2px 0 0;"></i>参考: [Kerasでモデルの保存/ロードを行う](https://keras.io/ja/getting-started/faq/#keras-model)_
